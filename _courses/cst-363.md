...
Designed and built a normalized PostgreSQL database for running sports tournaments. Teams, players, venues, games, and statistics, with the schema built to answer real questions like standings and player performance rather than just store rows.
